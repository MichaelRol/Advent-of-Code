...
final class AOC2021Tests: XCTestCase {
    ...
    func test12() {
        let puzzle = Day12(inputFile: "input12")
        XCTAssertEqual(puzzle.part1(), "3563")
        XCTAssertEqual(puzzle.part2(), "105453")
    }
    
    func test13() {
        let puzzle = Day13(inputFile: "input13")
        XCTAssertEqual(puzzle.part1(), "716")
        XCTAssertEqual(puzzle.part2(), "97")
    }
    
    func test14() {
        let puzzle = Day14(inputFile: "input14")
        XCTAssertEqual(puzzle.part1(), "2891")
        XCTAssertEqual(puzzle.part2(), "4607749009683")
    }
        
    func test15() {
        let puzzle = Day15(inputFile: "input15")
        XCTAssertEqual(puzzle.part1(), "790")
        XCTAssertEqual(puzzle.part2(), "2998")
    }
    
    func test25() {
        let puzzle = Day25(inputFile: "input25")
        XCTAssertEqual(puzzle.part1(), "300")
